...
$email_pengirim = 'panjihotim266@gmail.com'; // Isikan dengan email pengirim
$nama_pengirim = 'Syamsudin'; // Isikan dengan nama pengirim
...
$mail->Password = 'vppowqwlikwznujc'; // Isikan dengan Password email pengirim
$mail->Port = 465;
$mail->SMTPAuth = true;
$mail->SMTPSecure = 'ssl';
...
$mail->Subject = $subjek;
$mail->Body = $content;
$mail->AddEmbeddedImage('image/udin.jpg', 'cid:logo_mynotescode', 'udin.jpg'); // Aktifkan jika ingin menampilkan gambar dalam email
